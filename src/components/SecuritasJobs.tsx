          ...
          <div className="relative">
            <div className="bg-securitas-navy rounded-lg overflow-hidden aspect-video flex items-center justify-center">
              <div className="text-center text-white p-8">
                <div className="text-securitas-red text-2xl mb-4">●●●</div>
                ...
                <Button 
                  variant="outline" 
                  className="mt-4 bg-transparent border-white text-white hover:bg-white hover:text-securitas-navy"
                >
                  Watch Video
                </Button>
              </div>
          ...
          <div>
            <Card className="border-none shadow-lg">
              <CardContent className="p-8">
                ...
                <Button 
                  size="lg"
                  className="bg-securitas-navy hover:bg-securitas-navy/90 text-white px-8 py-6 text-lg"
                >
                  APPLY NOW
                </Button>
              </CardContent>
